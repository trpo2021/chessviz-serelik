...
void figure_transfer(const int& start_x,
                     const int& start_y,
                     const int& final_x,
                     const int& final_y) {
...
int pawn_move(const int& start_x,
              const int& start_y,
              const int& final_x,
              const int& final_y) {
...
int pawn_attack(const int& start_x,
                const int& start_y,
                const int& final_x,
                const int& final_y) {
  int forward_direction = 1;
...
int move_and_attack_pawn(const int& start_x,
                         const int& start_y,
                         const int& final_x,
                         const int& final_y) {
...
int figure_move(const int& start_x,
                const int& start_y,
                const int& final_x,
                const int& final_y) {
